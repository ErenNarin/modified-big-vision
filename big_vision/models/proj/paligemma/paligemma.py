...
class Model(nn.Module):
  ...
  def embed_image(self, image, train=False, region_masks=None):
    out = {}
    ...
    zimg, out_img = self._img_model(image, train=train, region_masks=region_masks)
  ...
  def embed_image_and_text(self, image, text, *,
                           input_mask=None, mask_ar=None, train=False, region_masks=None):
    ...
    Returns:
      ...
      :param region_masks:
    """
    zimg, out_img = self.embed_image(image, train=train, region_masks=region_masks)
  ...
  def __call__(self, image, text, mask_ar, train=False, region_masks=None):
    ...
    (x, input_mask, mask_ar), out = self.embed_image_and_text(
        image, text, mask_ar=mask_ar, train=train, region_masks=region_masks)
